...
if (isset($_POST['simpan'])) {
  ...
  if (empty($isi)) {
    header("Location: tambah_budaya.php?gagal=1");
  } else {
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
      ...
      // } else {
      $simpan = mysqli_query($koneksi, "INSERT INTO artikel VALUES ('','$kategori','$judul','$asal','$gambarbaru','$preview','$isi','$tanggal','$penulis','',0)");
      if ($simpan) {
        header("Location: budaya.php?tambah=1");
      }
    }
  }
}
    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          ...
          <h4><i class="fas fa-handshake me-1"></i> Budaya</h4>
        </div>
        <div class="container mb-5">
          <form action="" method="POST" enctype="multipart/form-data">
            ...
            <a href="budaya.php" class="btn btn-danger mt-4 mb-5"><i class="fas fa-arrow-circle-left"></i> Kembali</a>
